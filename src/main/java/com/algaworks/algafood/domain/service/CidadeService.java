...
public class CidadeService {
	...
	public Cidade buscarOuFalhar(Long id) {
		return cidadeRepository
				.findById(id)
				.orElseThrow(() -> new EntidadeNaoEncontradaException(format(MSG_CIDADE_NAO_ENCONTRADA, id)));
	}
	...
	public void remover(Long id) {
		try {
			...
			throw new EntidadeNaoEncontradaException(format(MSG_CIDADE_NAO_ENCONTRADA, id));
